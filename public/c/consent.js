...
var e=document.createElement("script");e.src=b+"script.js"+(v?"?v="+v:"");e.async=true;(document.head||document.documentElement).appendChild(e);if(e.type==="text/plain")e.type="text/javascript"};x.onerror=function(){var e=document.createElement("script");e.src=b+"script.js";e.async=true;(document.head||document.documentElement).appendChild(e);if(e.type==="text/plain")e.type="text/javascript"};x.send()})();
