 ...
 *   - tcf_data: IAB TCF v2.4 string (optional)
...
final class ConsentLogHandler implements RequestHandlerInterface
{
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $site = $this->db->fetchAssociative(
            'SELECT id, consent_log_enabled FROM oci_sites WHERE website_key = :key AND status = :status',
        ...
        $this->consentService->processConsent(
            ...
            [
                ...
                'log_enabled' => (int) ($site['consent_log_enabled'] ?? 1) === 1,
