...
final class ReportDataService
{
    public function __construct(
        ...
        // A/B-test data sources — supplied only in the Cloud Edition (the ABTest
        // module wires them explicitly). Null in the open-source core, where the
        // report simply omits the A/B section. Kept type-neutral so core carries
        // no dependency on the cloud module.
        private readonly ?object $abTestRepo = null,
        private readonly ?object $revenueRepo = null,
    ) {}
