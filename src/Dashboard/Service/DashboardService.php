...
final class DashboardService
{
     ...
     *
     * @param array<string, mixed> $currentUser
     * @return array{recommendations: array<int, array{text: string, status: string}>, complianceScore: int, siteStatus?: string}
     */
    public function getRecommendationsWithScore(array $currentUser, int $siteId): array
    {
        ...
        return [
            ...
            'frameworks' => $frameworkCompliance['frameworks'] ?? [],
            'frameworkWarnings' => $frameworkCompliance['warnings'] ?? [],
        ];
    }
