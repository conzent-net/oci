    ...
    public function processWebhookResults(array $payload): void
    {
        ...
        foreach ($results as $result) {
            ...
            foreach ($cookies as $cookie) {
                ...
                if ($cookieName === '') {
                    continue; // glitch: a cookie with no name is not real
                }
            ...
            // Store beacons. The identity is host + path — the actual script
            // or pixel, not just its domain (googletagmanager.com/gtm.js vs
            // a bare googletagmanager.com tells the admin what fired). The
            // query string is stripped so per-visitor parameters cannot
            // explode row cardinality.
            ...
            foreach ($beacons as $beacon) {
                ...
                if ($beaconUrl === '') {
                    continue; // glitch: a beacon with no URL is not real
                }
