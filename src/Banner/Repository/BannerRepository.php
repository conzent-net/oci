...
final class BannerRepository implements BannerRepositoryInterface
{
    ...
    public function deleteSiteBanner(int $bannerId): void
    {
        // Delete field translations first (child rows)
        $this->db->delete('oci_site_banner_field_translations', ['site_banner_id' => $bannerId]);
        $this->db->delete('oci_site_banners', ['id' => $bannerId]);
    }
}
