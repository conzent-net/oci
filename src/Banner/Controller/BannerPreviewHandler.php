...
final class BannerPreviewHandler implements RequestHandlerInterface
{
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        <head>
            ...
            <!-- Not async: matches the canonical snippet (docs/embed-snippet.md), so
                 the preview loads the banner exactly the way a real site does. -->
            <script src="{$scriptUrl}" data-key="{$websiteKey}"></script>
        </head>
        <body>
