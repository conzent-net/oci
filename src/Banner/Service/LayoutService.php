...
final class LayoutService
{
    ...
    private const REQUIRED_VARIABLES = [
        ...
        // The placeholder must exist so generation can substitute it; the badge
        // itself is optional and resolves to an empty string when disabled.
        '{{ branding_html|raw }}' => 'Powered-by branding placeholder',
