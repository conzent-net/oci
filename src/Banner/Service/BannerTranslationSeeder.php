...
final class BannerTranslationSeeder
{
    ...
    private const CATEGORY_CACHE_FILE = 'resources/data/category-translations.php';
...
PROMPT;
    ...
    /**
     * Load the static cookie-category translation cache.
     *
     * @return array<string, array<string, array{name: string, description: string}>> [lang_code => slug => texts]
     */
    public function loadCachedCategoryTranslations(): array
    {
        $path = $this->basePath . '/' . self::CATEGORY_CACHE_FILE;
    ...
    /**
     * Save cookie-category translations to the static cache file.
     *
     * @param array<string, array<string, array{name: string, description: string}>> $translations
     */
    public function saveCachedCategoryTranslations(array $translations): void
    {
        $path = $this->basePath . '/' . self::CATEGORY_CACHE_FILE;
