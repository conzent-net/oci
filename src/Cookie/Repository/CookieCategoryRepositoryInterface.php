...
interface CookieCategoryRepositoryInterface
{
    ...
    /**
     * Get every stored site-category translation for a site.
     *
     * @return array<int, array<int, array{name: string, description: string}>> site_cookie_category_id => language_id => texts
     */
    ...
    /**
     * Get a single global category by ID (with its translated name).
     *
     * @return array<string, mixed>|null
     */
