...
final class CookieListHandler implements RequestHandlerInterface
{
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $categoryList = $this->cookieService->getCategoryList($siteId);
        ...
        $templateData = [
            ...
            'categoryOptions' => $categoryList['globalCategories'],
            'pendingRequestNames' => $this->reclassService->getPendingNamesForSite($siteId),
        ];
